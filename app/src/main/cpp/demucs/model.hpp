...
{
    int num_sources;
    bool use_4source_crosstransformer;
...
initialize_crosstransformer(bool use_4source_transformer)
{
    if (use_4source_transformer)
    {
...
bool load_demucs_model(const std::vector<char> &model_data,
                       struct demucs_model *model);

bool load_demucs_model(const char* model_data, int n_bytes,
                                  struct demucs_model *model);
...
bool load_demucs_v3_model(const char *model_data, int n_bytes,
                       struct demucs_v3_model *model);
bool load_demucs_v3_model(const std::vector<char> &model_data,
                       struct demucs_v3_model *model);
